...
// Header
#include "rviz_plugin/slam_rviz_plugin.hpp"
// ROS
...
/*****************************************************************************/
{
  ...
  paused_measure = ros_node_->declare_parameter(
    "/slam/paused_new_measurements", paused_measure);
  interactive = ros_node_->declare_parameter(
    "/slam/interactive_mode", interactive);
  ...
  _serialize =
    ros_node_->create_client<slam::srv::SerializePoseGraph>(
    "/slam/serialize_map");
  _load_map =
    ros_node_->create_client<slam::srv::DeserializePoseGraph>(
    "/slam/deserialize_map");
  _clearChanges = ros_node_->create_client<slam::srv::Clear>(
    "/slam/clear_changes");
  _saveChanges = ros_node_->create_client<slam::srv::LoopClosure>(
    "/slam/manual_loop_closure");
  _saveMap = ros_node_->create_client<slam::srv::SaveMap>(
    "/slam/save_map");
  _clearQueue = ros_node_->create_client<slam::srv::ClearQueue>(
    "/slam/clear_queue");
  _interactive =
    ros_node_->create_client<slam::srv::ToggleInteractive>(
    "/slam/toggle_interactive_mode");
  _pause_measurements = ros_node_->create_client<slam::srv::Pause>(
    "/slam/pause_new_measurements");
  _load_submap_for_merging =
    ros_node_->create_client<slam::srv::AddSubmap>(
    "/map_merging/add_submap");
  _merge = ros_node_->create_client<slam::srv::MergeMaps>(
...
{
  auto request =
    std::make_shared<slam::srv::SerializePoseGraph::Request>();
...
/*****************************************************************************/
{
  typedef slam::srv::DeserializePoseGraph::Request procType;
...
/*****************************************************************************/
{
  auto request = std::make_shared<slam::srv::AddSubmap::Request>();
...
/*****************************************************************************/
{
  auto request = std::make_shared<slam::srv::MergeMaps::Request>();
...
/*****************************************************************************/
{
  auto request = std::make_shared<slam::srv::Clear::Request>();
...
/*****************************************************************************/
{
  auto request = std::make_shared<slam::srv::LoopClosure::Request>();
...
/*****************************************************************************/
{
  auto request = std::make_shared<slam::srv::SaveMap::Request>();
...
/*****************************************************************************/
{
  auto request = std::make_shared<slam::srv::ClearQueue::Request>();
...
{
  auto request =
    std::make_shared<slam::srv::ToggleInteractive::Request>();
...
/*****************************************************************************/
{
  auto request = std::make_shared<slam::srv::Pause::Request>();
...
/*****************************************************************************/
{
  ...
  auto parameters_client =
    std::make_shared<rclcpp::SyncParametersClient>(node, "slam");
...
PLUGINLIB_EXPORT_CLASS(slam::SlamToolboxPlugin, rviz_common::Panel)
