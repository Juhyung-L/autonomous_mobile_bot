...
#include <memory>
#include "slam/slam_async.hpp"

namespace slam
{

/*****************************************************************************/
AsynchronousSlam::AsynchronousSlam(rclcpp::NodeOptions options)
: Slam(options)
/*****************************************************************************/
{
}
...
/*****************************************************************************/
void AsynchronousSlam::laserCallback(
...
/*****************************************************************************/
bool AsynchronousSlam::deserializePoseGraphCallback(
...
/*****************************************************************************/
{
  ...
  return Slam::deserializePoseGraphCallback(request_header, req, resp);
}
