...
/*****************************************************************************/
{
  server_ = node_->create_service<slam::srv::SaveMap>("slam/save_map",
...
bool MapSaver::saveMapCallback(
  ...
  const std::shared_ptr<slam::srv::SaveMap::Request> req,
...
/*****************************************************************************/
{
  ...
  if (name != "") {
    RCLCPP_INFO(node_->get_logger(),
      "Slam: Saving map as %s.", name.c_str());
    ...
    RCLCPP_INFO(node_->get_logger(),
      "Slam: Saving map in current directory.");
