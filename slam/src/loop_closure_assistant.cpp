...
/*****************************************************************************/
{
  ...
  ssClear_manual_ = node_->create_service<slam::srv::Clear>(
    "slam/clear_changes", std::bind(&LoopClosureAssistant::clearChangesCallback, 
    this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));
  
  ssLoopClosure_ = node_->create_service<slam::srv::LoopClosure>(
    "slam/manual_loop_closure", std::bind(&LoopClosureAssistant::manualLoopClosureCallback,
    this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));
  
  scan_publisher_ = node_->create_publisher<sensor_msgs::msg::LaserScan>(
    "slam/scan_visualization",10);
  ...
  ssInteractive_ = node_->create_service<slam::srv::ToggleInteractive>(
    "slam/toggle_interactive_mode", std::bind(&LoopClosureAssistant::interactiveModeCallback,
    this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));


  marker_publisher_ = node_->create_publisher<visualization_msgs::msg::MarkerArray>(
    "slam/graph_visualization", rclcpp::QoS(1));
...
/*****************************************************************************/
{
  ...
  visualization_msgs::msg::Marker m = vis_utils::toMarker(map_frame_, "slam", 0.1, node_);
  ...
  localization_edges_marker.ns = "slam_edges";
...
/*****************************************************************************/
{
  ...
  RCLCPP_INFO(node_->get_logger(),
     "Slam: Toggling %s interactive mode.",
